                        ...
                        <div className='flex mb-2'>
                          <div className="w-full lg:w-2/12 ">
                            <span className="flex">
                              ...
                              <input id="checkbox-1" aria-describedby="checkbox-1" type="checkbox"
                                onClick={() => {
                                  setDeviceData({ ...deviceData, tick: !deviceCheck }),
                                  setDeviceCheck(!deviceCheck)
                                }} checked={deviceCheck === true}
                                className="bg-gray-50 border-gray-300 my-2 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded" />
                              <label htmlFor="checkbox-1" className="sr-only">checkbox</label>
              ...
              <div className="items-center flex p-6 border-t border-gray-200 rounded-b">
                <Button Primary={language?.Update} onClick={() => {
                  if ((flag === 1) ||
                    ...
                    (countryCheck === true && countryData.data !== undefined && countryData.data !== "" && countryData.tick === undefined)
                    ||
