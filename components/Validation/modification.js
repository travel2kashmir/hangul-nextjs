const validateModifications= (data) =>{
    var error={};
     var flag=[]
     var final_flag=true;
     console.log(data)
     ...
     {
         flag.push(false)
         error.availability="The availability is required."
     }
     if(data?.rate_rule_id==="" || data?.rate_rule_id===undefined)
     {
         flag.push(false)
         error.raterule="The rate rule is required."
     }
 ...
 if(data?.booking_window_min >= data?.booking_window_max)
{
 ...
 export default  validateModifications
