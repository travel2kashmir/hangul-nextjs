        ...
        <>
            ...
            <div id="main-content"
                            ...
                            <div className="align-middle inline-block min-w-full">
                                <div className="shadow overflow-hidden">
                                    <table className="table-fixed min-w-full divide-y divide-gray-200">
                                        ...
                                        <TableList Primary={gen} Edit={language?.EditService}
                                            EditButton={(item) => {
                                                setEdit(1); setActionService(item);
                                            }}
                                        />
                                    </table>
                                    ...
                                    <div className="align-middle inline-block min-w-full">
                                        <div className="shadow overflow-hidden">
                                            <table className="table-fixed min-w-full divide-y divide-gray-200">
                                                ...
                                                <TableList Primary={gene} Edit={language?.EditService} Delete={language?.DeleteService}
                                                    EditButton={(i) => {
                ...
                <div className={edit === 1 ? 'block' : 'hidden'}>
                    {actionService.type === 'yes' || actionService.type === 'no' ? <div>
