...
const Delete ={
 ...
 <div className="sm:flex">
     ...
     <Button Primary={AddRoom}  onClick={()=>{Router.push("./rooms/addroom")}}/>
                     ...
                     {allrooms?.map((allrooms,index) => (
                         <tr className="hover:bg-gray-100" key={index}>
                           ...
                           <div className="flex items-center">
                             ...
                             <Button Primary={EditRoom}   onClick={() => {
                                          CurrentRoom(allrooms?.room_id),
                                         Router.push("./rooms/room");
                                         }}/>
                                 <Button Primary={DelRoom} onClick={()=>{
                                         setDeleteRoom(1);
     ...
     <div className="bg-white rounded-lg shadow relative">
         ...
         <div className="p-6 pt-0 text-center">
             ...
             <h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">
                 ...
                 <Button Primary={Delete}   onClick={()=>{deleteRooms();setDeleteRoom(0)}}/>
                 <Button Primary={Cancel}    onClick={()=>setDeleteRoom(0)}/>
