...
function Packagemiles() {
  ...
  const [modified, setModified] = useState({})
   ...
   /** Fetching property from the local storage **/
  let currentProperty=JSON.parse(localStorage.getItem('property'))
  
   /** Fetching package details from the local storage **/
  let currentMiles=JSON.parse(localStorage.getItem('packageDescription'))
  ...
  return (
      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2">
        ...
        <li>
          <div className="flex items-center">
            ...
            <span className="text-gray-700 text-sm font-medium hover:text-gray-900 capitalize ml-1 md:ml-2">
            <Link href="/propertysummary" >{currentProperty?.property_name}</Link></span>
          </div>
        </li>
        <li>
          <div className="flex items-center">
        ...
        <li>
          <div className="flex items-center">
            <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
            <span className="text-gray-700 text-sm font-medium hover:text-gray-900 capitalize ml-1 md:ml-2">
            <Link href="/package" >{currentMiles?.package_name}</Link></span>
          </div>
        </li>
        <li>
          <div className="flex items-center">
    ...
    {/* Header */}
    <div className="mx-4">
      <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">{t.package} Miles
      </h1>
        ...
        <div className="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
          <form className="lg:pr-3" action="#" method="GET">
            ...
            <div className="mt-1 relative lg:w-64 xl:w-96">
              <input type="text" name="email" id="users-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for Miles">
              </input>
            </div>
          </form>
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="first-name" className="text-sm font-medium text-gray-900 block mb-2">{t.number} {t.of} miles</label>
                ...
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="last-name" className="text-sm font-medium text-gray-900 block mb-2">Mile {t.provider}</label>
                  <input type="text" id="last-name"
          ...
          <div className="bg-white rounded-lg shadow relative">
            ...
            <div className="items-center p-6 border-t border-gray-200 rounded-b">
              <button className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                 onClick={submitMileAdd} type="submit">{t.add} Mile</button>
            </div>
          </div>
        </div>
      </div>
