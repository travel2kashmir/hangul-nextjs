const validateRoom = (data) =>{
   ...
   {
       flag.push(false)
       error.room="The room name is required."
   }
     ...
     if(data?.room_breadth==="" || data?.room_breadth===undefined)
     {
         flag.push(false)
         error.room_breadth="The room breadth is required."
     }
     ...
     {
         flag.push(false)
         error.room_breadth="The room breadth accepts only numbers and decimal values. "
     }
    }
     if(data?.room_height!=="" || data?.room_height!==undefined)
     {
