...
function Gallery() {
 /** Fetching language from the local storage **/
  ...
  let gallery=JSON.parse(localStorage.getItem('allPropertyDetails'))
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-2">
          ...
          <li>
            <div className="flex items-center">
              ...
              <span className="text-gray-700 text-sm   font-medium hover:text-gray-900 ml-1 md:ml-2">{gallery?.property_name}</span>
            </div>
          </li>
          <li>
            <div className="flex items-center">
                            ...
                            <div className="p-6 space-y-6">
                                <div className="grid grid-cols-6 gap-6">
                                    <div className="col-span-6 sm:col-span-3">
                                        <img src={actionImage?.image_link} alt='property_imag'  height= {"200"} width={400}  />
