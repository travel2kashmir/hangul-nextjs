...
function Raterules() {
  ...
  const CurrentRateRule = (rateRuleId ) => {
    localStorage.setItem("RateRuleId", (rateRuleId));
  };
  return (
    <>
 ...
 <div className="sm:flex">
     ...
     <Button Primary={language?.AddRateRule}  onClick={()=>{Router.push("./rooms/addroom")}}/>
 ...
 <div className="overflow-x-auto">
     <div className="align-middle inline-block min-w-full">
         ...
         <table className="table-fixed min-w-full divide-y divide-gray-200">
          ...
          <TableList Primary={gen} Edit={language?.EditRateRule} Delete={language?.DeleteRateRule} 
          EditButton={(item) => {
             CurrentRateRule(item?.id),Router.push("./raterules/raterule"); }}
