    ...
    return (
        <>
            ...
            <div id="main-content"
                ...
                <div className="mx-4">
                    <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">ARI</h1>
                    <div className="sm:flex">
                        <div className=" sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                            <form className="lg:pr-3" action="#" method="GET">
                                <label htmlFor="users-search" className="sr-only">Search</label>
                                <div className="mt-1 relative lg:w-64 xl:w-96">
                                    <input type="text" name="email" id="myInput"
                            ...
                            <div className="flex space-x-1 pl-0 sm:pl-2 mt-3 sm:mt-0">
                                ...
                                <button data-tooltip="Delete" aria-label="Delete" className="text-gray-500 hover:text-gray-900 cursor-pointer p-1 hover:bg-gray-100 rounded inline-flex justify-center">
           ...
           items-center ease-linear transition-all duration-150"onClick={() => { setViewTransaction(!viewTransaction) }}>
                                        ...
                                        {allPackages.map((item, index) => (
                                            <tr className="hover:bg-gray-100" key={index}>
                                                ...
                                                <td className="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                    <span className="p-4 capitalize whitespace-nowrap text-base font-medium text-gray-900">{item?.package_name} </span>
                                                </td>
            ...
            focus:ring-4 focus:ring-cyan-200 font-semibold bg-cyan-600 hover:bg-cyan-700 text-white
             ...
             items-center  mb-1 ease-linear transition-all duration-150">
                                                    ...
                                                    <button className="bg-gradient-to-r  sm:inline-flex  
            focus:ring-4 focus:ring-green-200 font-semibold bg-green-600 hover:bg-green-700 text-white
             rounded-lg text-sm px-5 py-2 text-center 
             items-center  mb-1 ease-linear transition-all duration-150">
                                                        Add Availability
                                                    </button>
