...
function Contact() {
  ...
  let contacts = JSON.parse(localStorage.getItem("allPropertyDetails"));
  ...
  function submitContactAdd(e) {
    ...
    axios
      .post(`/api/contact`, JSON.stringify(contact), {
            ...
            <div className="bg-white rounded-lg shadow relative">
              ...
              <div className="p-6 pt-0 text-center">
                ...
                <h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">
                  Are you sure you want to delete {editContact?.contact_type}{" "}
                  {editContact?.contact_data}?
                </h3>
                <button
