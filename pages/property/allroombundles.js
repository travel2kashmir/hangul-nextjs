...
function Allroombundles() {
  ...
  return (
    ...
    className="  bg-gray-50 px-4 pt-24 relative overflow-y-auto lg:ml-64">
      ...
      {/* Header */}
 <div className="mx-4">
 <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Room Bundles</h1>
 <div className="sm:flex">
     <div className="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
         <form className="lg:pr-3" action="#" method="GET">
             <label htmlFor="users-search" className="sr-only">{language?.search}</label>
             <div className="mt-1 relative lg:w-64 xl:w-96">
                 <input type="text" name="email" id="users-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for room bundles">
                 </input>
             </div>
         </form>
     ...
     <Button Primary={language?.AddRoomBundle}  onClick={() => {Router.push("./roombundles/addroombundles")}}/> 
